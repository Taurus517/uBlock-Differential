...
int main(){
    ...
    FILE *fp1 = NULL; 
    FILE *fp2 = NULL; 
    fp1 = popen("stp 8R_2-8_256_nus_trail.cvc", "r"); //
    ...
    while(str_read.compare("Valid.") != 0){
        ...
        OriginalCVC.open("8R_2-8_256_nus_trail.cvc", ios::in); //
        ofstream TempCVC;
        ...
        OriginalCVC1.open("8R_2-8_256_nus_trail.cvc", ios::out); //
        ...
        OriginalCVC2.open("8R_2-8_256_nus_trail.cvc", ios::app); //
        ...
        FILE *Refresh = NULL; 
        FILE *fh1=NULL;
        Refresh = popen("stp 8R_2-8_256_nus_trail.cvc", "r"); //
