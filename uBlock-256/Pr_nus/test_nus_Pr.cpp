...
int main(){
    ...
    FILE *fp1 = NULL; 
    FILE *fp2 = NULL; 
    fp1 = popen("stp 8R_2-8_nus_Pr.cvc", "r"); //
    ...
    while(str_read.compare("Valid.") != 0){
        ...
        OriginalCVC.open("8R_2-8_nus_Pr.cvc", ios::in); //
        ofstream TempCVC;
        ...
        OriginalCVC1.open("8R_2-8_nus_Pr.cvc", ios::out); //
        ...
        OriginalCVC2.open("8R_2-8_nus_Pr.cvc", ios::app); //
        ...
        FILE *Refresh = NULL; 
        FILE *fh1=NULL;
        Refresh = popen("stp 8R_2-8_nus_Pr.cvc", "r"); //
