...
/*************************************** Pr_nus **********************************************/
    ...
    string Pr_th = "0bin000100000000"; //256 
    //string Pr_th = "0bin000100000100"; //260
    //string Pr_th = "0bin000100000111"; //263
    //string Pr_th = "0bin000100001000"; //264
    //string Pr_th = "0bin000100001010"; //266
    //string Pr_th = "0bin000100001011"; //267
    //string Pr_th = "0bin000100001100"; //268
    //string Pr_th = "0bin000100001101"; //269
    //string Pr_th = "0bin000100001110"; //270

    fprintf(fp, "ASSERT total_Pr = %s;\n\n", Pr_th.c_str());
...
/*************************************** fix **********************************************/
    ...
    for(int state = 0; state < 32; state++){
        if( (state==1)||(state==3)||(state==5)||(state==7)||(state==9)||(state==11)||(state==13)||(state==15)||(state==17)||(state==19)||(state==21)||(state==23)||(state==25)||(state==27)||(state==29)||(state==31) ){
            fprintf(fp, "ASSERT X_0_R_%d = 0bin0001;\n", state);  
        }
    } 
    fprintf(fp, "\n");
    ...
    for(int state = 0; state < 32; state++){
        if( (state==1)||(state==3)||(state==5)||(state==7)||(state==9)||(state==11)||(state==13)||(state==15)||(state==17)||(state==19)||(state==21)||(state==23)||(state==25)||(state==27)||(state==29)||(state==31) ){
            fprintf(fp, "ASSERT x1_%d_R_%d = 0bin0001;\n", ROUNDS-1, state);  
        }
    } 
    fprintf(fp, "\n");
